...
*Дружелюбны ли еноты?*
        ...
        # Step 8
        self.mongo_client.send({'Problem': '''
Курс закончет, всем спасибо. Ждите следующих курсов посвященных ентовидным собакам и прочим представителям семейства енотовых.
                                    ''',
                                'Wrong_answers': [],
                                'Right_answer': 'Finish',
                                'Positive_answer': "До свидания и до новых встреч.",
                                'Order': 8,
                                })
