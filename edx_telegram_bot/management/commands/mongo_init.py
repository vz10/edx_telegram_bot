...
Как ни жаль об этом говорить, но на этом наш курс закончет. Ждите следующих курсов посвященных ентовидным собакам и прочим представителям семейства енотовых.
                                                   """,
                                'Order': 7
                                })
